...
crunch = [('almond crocanti', 'almond crocanti'), ('chips ahoy!', 'chips ahoy!'),
          ...
          ('Lacasitos', 'Lacasitos')]
sauce = [('Blueberry Sauce', 'Blueberry Sauce'), ('Creamy Caramel Sauce', 'Creamy Caramel Sauce'),
         ('white chococrock','white chococrock'), ('dark chocolate', 'dark chocolate'),
...
TOPPINGS_DICT = {
    ...
    'Mini Cookies': '#AA7733',
    'Lotus Crushed Caramel Biscoff Biscquit': '#B6855A',
    'Lacasitos': '#FFB22C',
    'Blueberry Sauce': '#5B2581',
    'Creamy Caramel Sauce': '#C78752',
